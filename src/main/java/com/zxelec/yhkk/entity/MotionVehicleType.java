 ...
 * Kafka过车记录推送
 */
public class MotionVehicleType implements Serializable{
...
//    private Integer vehicleColor;  暂时改为string
    ...
    private List<VehiclePictureType> pictures;
...
//    }
    ...
    public List<VehiclePictureType> getPictures() {
        return pictures;
    }

    public void setPictures(List<VehiclePictureType> pictures) {
